...
function Forms() {
  ...
  const { extractedText, extractingData, pdfFiles, geoPisarna, stevilka, ko, stevilkaElaborata, stTehPos, pi, dopolnitiDo, vodjaPostopka,ugotovitevUprave, setGeoPisarna, setStevilka, setKo, setStevilkaElaborata, setStTehPos, setPi, setDopolnitiDo, setVodjaPostopka, setUgotovitevUprave } = usePdf();
